...
//            int permissionCheck3 = checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE); READ_EXTERNAL_STORAGE
            ...
            if (checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_DENIED ||
                ...
                requestPermissions(new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1000);
            }
            else {
